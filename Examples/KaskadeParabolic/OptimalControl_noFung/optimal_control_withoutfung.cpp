...
int main( int argc, char* argv[] )
{
    ...
    ::Spacy::KaskadeParabolic::GridManager< Spaces > gm1( 101, ::Spacy::Real{ 30. }, initialRefinements, FEorder );
    ...
    ::Spacy::KaskadeParabolic::GridManager< Spaces > gm2( 11, ::Spacy::Real{ 30. }, initialRefinements, FEorder );
    ...
    ::Spacy::KaskadeParabolic::GridManager< Spaces > gm3( 11, ::Spacy::Real{ 30 }, initialRefinements, FEorder, "exponential",
                                                          expgridparam );
