...
int main()
{
    ...
    std::function< HeatFunctionalDefinition( const VariableSetDesc::VariableSet ) >
        forwardFunctionalGenerator = [&d, &mu]( const VariableSetDesc::VariableSet control ) {
    ...
    auto& source_impl =
        ::Spacy::cast_ref<::Spacy::KaskadeParabolic::Vector< VariableSetDesc > >( source );
    for ( auto i = 0u; i < no_time_steps; i++ )
        source_impl.get_nonconst( i ) = 1.;

    auto A = Spacy::KaskadeParabolic::makeC1Operator( forwardFunctionalGenerator, gm, domain,
                                                      domain.dualSpace(), source );
    ...
    auto& vc =
        ::Spacy::creator<::Spacy::KaskadeParabolic::VectorCreator< VariableSetDesc > >( domain );
    vc.refine( 8 );
    ...
    ::Spacy::KaskadeParabolic::PDE::writeVTK(
        Spacy::cast_ref<::Spacy::KaskadeParabolic::Vector< VariableSetDesc > >( x ), "refnonopt" );
    ...
    ::Spacy::KaskadeParabolic::PDE::writeVTK(
        Spacy::cast_ref<::Spacy::KaskadeParabolic::Vector< VariableSetDesc > >( x3 ), "refopt" );
