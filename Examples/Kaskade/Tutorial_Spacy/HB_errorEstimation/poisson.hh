...
/// using PrecondType::HB error estimation for adaptive mesh refinement
...
public:
    ...
    public:
        ...
        void evaluateAt( Position const& x, Evaluators const& evaluators )
        {
            ...
            int dim = AnsatzVars::Grid::dimension;
    ...
    public:
        ...
        void evaluateAt( Dune::FieldVector< typename AnsatzVars::Grid::ctype, AnsatzVars::Grid::dimension - 1 > const& x,
