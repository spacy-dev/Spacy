...
TEST( DampingFactor, TwoPlusThreeEqualsFive )
{
    ...
    const auto typeOf_two_plus_three_damping_IsReal = std::is_same< decltype( two_plus_three_damping ), const Spacy::Real >::value;
...
TEST( DampingFactor, TwoMinusThreeEqualsMinusOne )
{
    ...
    const auto typeOf_two_minus_three_damping_IsReal = std::is_same< decltype( two_minus_three_damping ), const Spacy::Real >::value;
...
TEST( DampingFactor, TwoTimesThreeEqualsSix )
{
    ...
    const auto typeOf_two_damping_times_three_IsReal = std::is_same< decltype( two_damping_times_three ), const Spacy::Real >::value;
    ...
    const auto typeOf_two_times_three_damping_IsReal = std::is_same< decltype( two_times_three_damping ), const Spacy::Real >::value;
...
TEST( DampingFactor, TwoDivThreeEqualsTwoThird )
{
    ...
    const auto typeOf_two_damping_div_three_IsReal = std::is_same< decltype( two_damping_div_three ), const Spacy::Real >::value;
    ...
    const auto typeOf_two_div_three_damping_IsReal = std::is_same< decltype( two_div_three_damping ), const Spacy::Real >::value;
