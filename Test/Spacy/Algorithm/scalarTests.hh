...
#define GENERATE_SCALAR_TEST( ALGORITHM, TESTCASE, REQUIRED_STEPS )                                \
    ...
    {                                                                                              \
        TESTCASE testCase;                                                                         \
        auto solver1 = createSolver( testCase.example(), testCase.relativeAccuracy(),              \
                                     testCase.eps(), REQUIRED_STEPS );                             \
        auto solver2 = createSolver( testCase.example(), testCase.relativeAccuracy(),              \
                                     testCase.eps(), REQUIRED_STEPS + 1 );                         \
        auto solver3 = createSolver( testCase.example(), testCase.relativeAccuracy(),              \
                                     testCase.eps(), REQUIRED_STEPS - 1 );                         \
                                                                                                   \
