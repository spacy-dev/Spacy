        ...
        ProductSpaceC1Operator()
            : spaces( two_spaces() ), V( ProductSpace::makeHilbertSpace( spaces ) ),
              ...
              A22( []( double x ) { return x * x * x; }, []( double x ) { return 3 * x * x; },
                   *spaces[ 1 ], *spaces[ 1 ] ),
              A31( []( double ) { return 1; }, []( double ) { return 0; }, *spaces[ 0 ],
                   *spaces[ 1 ] ),
              A32( []( double x ) { return 2 * x * x; }, []( double x ) { return 4 * x; },
                   *spaces[ 1 ], *spaces[ 1 ] )
        {
        }
...
TEST( ProductSpaceC1Operator_2x3, Apply )
{
    ...
    Scalar::C1Operator A11( []( double x ) { return x * x; }, []( double x ) { return 2 * x; },
                            *domain_spaces[ 0 ], *range_spaces[ 0 ] );
    Scalar::C1Operator A12( []( double x ) { return x; }, []( double ) { return 1; },
                            *domain_spaces[ 1 ], *range_spaces[ 0 ] );
    Scalar::C1Operator A21( []( double ) { return 1; }, []( double ) { return 0; },
                            *domain_spaces[ 0 ], *range_spaces[ 1 ] );
    Scalar::C1Operator A22( []( double x ) { return x * x * x; },
                            []( double x ) { return 3 * x * x; }, *domain_spaces[ 1 ],
                            *range_spaces[ 1 ] );
    Scalar::C1Operator A31( []( double ) { return 1; }, []( double ) { return 0; },
                            *domain_spaces[ 0 ], *range_spaces[ 2 ] );
    Scalar::C1Operator A32( []( double x ) { return x * x; }, []( double x ) { return 2 * x; },
                            *domain_spaces[ 1 ], *range_spaces[ 2 ] );
