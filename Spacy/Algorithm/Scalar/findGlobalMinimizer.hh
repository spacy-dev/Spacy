...
namespace Spacy
{
    namespace Scalar
    {
         ...
         * methods.
         * Performs a scalar linesearch on the parameter \f$ x \f$ of \f$ dn+x*Dt \f$ such that this
         * sum minimizes the function \f$ f \f$
         * It will start from the upper bound and proceed to the lower bound logarithmically,
         * however it will stop, as soon as the
         * norm of \f$ dn+x*Dt \f$ increases for decreasing \f$ x \f$. This is possible, if dn and
         * Dt are not orthogonal.
         * @param f Nonlinear function \f$ f: \mathbb{R}\to\mathbb{R} \f$
         * @param a lower bound of the admissible interval
         * @param b upper bound of the admissible interval
         ...
         * @param eps relative accuracy
         * @return \f$ x \in \mathrm{argmin}_{[a,b]} \f$ such that it minimizes \f$ f(dn+x*dt) \f$
         * without increasing the norm of
         * the dn+x*dt
         */
