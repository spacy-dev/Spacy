...
namespace Spacy
{
  ...
  namespace MINRES
  {
     ...
     */
    class BlockDiagPreconditioner2
        : public OperatorBase,
    ...
    public:
       ...
       */
      BlockDiagPreconditioner2( ::Spacy::LinearSolver stateSolver,
                                               ::Spacy::LinearSolver controlSolver,
                                               ::Spacy::LinearSolver adjointSolver1,
                                ::Spacy::LinearSolver adjointSolver2,
                                ::Spacy::LinearSolver adjointSolver3,
    ...
    private:
      ...
      ::Spacy::LinearSolver stateSolver_, controlSolver_, adjointSolver1_, adjointSolver2_, adjointSolver3_;
