...
namespace Spacy
{
    namespace Algorithm
    {
         ...
         */
        class TrustRegionSolver : public Mixin::Eps,
                                  public Mixin::MaxSteps,
                                  public Mixin::RelativeAccuracy
        {
        public:
            using ComputeDescentDirection =
                std::function< Vector( const C2Functional& /*f*/, const Vector& /*x*/ ) >;
            using UpdateTrustRegionRadius = std::function< Real(
                Real /*trust_region_radius*/, Real /*|dx|*/, Real /*f(x)*/, Real /*q(x)*/ ) >;
