...
namespace Spacy
{
    ...
    namespace CompositeStep
    {
        ...
        public:
            /**
             * @brief Constructor.
             * @param quadraticModel quadratic model \f$q_1\f$ of the Lagrange functional (generated
             * with makeQuadraticModel(...))
             * @param squaredNorm quadratic model \f$q_2\f$ of a norm (generated with
             * makeQuadraticNormModel(...))
        ...
        /**
         * @brief Generate cubic regularized model for the affine covariant composite step method of
