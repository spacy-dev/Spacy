...
namespace Spacy
{
    ...
    Vector localNewton( const C1Operator& F, const Vector& x0, const Spacy::Newton::Parameter& p, const EstimateAndRefine& errorEstimator )
    {
        return Newton::newton< Newton::Damping::None, Newton::Termination::AffineCovariant >( F, x0, p, errorEstimator );
    }

    Vector localNewton( const C1Operator& F, const Newton::Parameter& p, const EstimateAndRefine& errorEstimator )
    {
    ...
    Vector covariantNewton( const C1Operator& F, const Spacy::Newton::Parameter& p, const EstimateAndRefine& errorEstimator )
    {
    ...
    Vector contravariantNewton( const C1Operator& F, const Vector& x0, const Spacy::Newton::Parameter& p,
                                const EstimateAndRefine& errorEstimator )
    {
        return Newton::newton< Newton::Damping::AffineContravariant, Newton::Termination::AffineContravariant >( F, x0, p, errorEstimator );
    }

    Vector contravariantNewton( const C1Operator& F, const Spacy::Newton::Parameter& p, const EstimateAndRefine& errorEstimator )
    {
