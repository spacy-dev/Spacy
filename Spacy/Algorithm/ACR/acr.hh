...
namespace Spacy
{
    ...
    {
        /**
         * @brief Adaptive cubic regularization approach for solving unconstrained minimization
         * problems
        ...
        private:
             ...
             */
            StepMonitor acceptanceTest( const Vector& x, const Vector& dx, const Real& lambda,
