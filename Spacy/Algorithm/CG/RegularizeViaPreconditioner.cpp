...
namespace Spacy::CG
{
    ...
    RegularizeViaPreconditioner::RegularizeViaPreconditioner( double minIncrease, double maxIncrease, double eps )
    ...
    void RegularizeViaPreconditioner::adjustResidual( Real alpha, const Vector& Pq, Vector& r ) const
    {
        r -= ( alpha * theta_ ) * Pq;
    }
    ...
    RegularizeViaCallableOperator::RegularizeViaCallableOperator( CallableOperator R, Real theta_sugg, double minIncrease,
        ...
        : Mixin::Eps( eps ), theta_( theta_sugg ), minIncrease_( minIncrease ), maxIncrease_( maxIncrease ), R_( std::move( R ) )
    {
    ...
    void RegularizeViaCallableOperator::adjustResidual( Real alpha, const Vector& Rq, Vector& r ) const
    {
        r -= ( alpha * theta_ ) * Rq;
    }
