...
namespace Spacy
{
    ...
    namespace dealII
    {
        ...
        public:
            ...
            {
                assemble( x );
                return LinearOperator< dim, VariableDims >{gradient_, *operator_space_,
                                                           boundary_values_, domain(), range()};
            }
        ...
        private:
            ...
            void assemble( const ::Spacy::Vector& x ) const
            {
                ...
                dealii::MatrixTools::apply_boundary_values(
                    get_boundary_map< dim, VariableDims >( domain(), *dof_handler_ ), gradient_,
                    boundary_vals, value_ );
