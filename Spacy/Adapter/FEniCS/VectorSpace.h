...
namespace Spacy
{
    ...
    namespace FEniCS
    {
        ...
        public:
             ...
             * @brief Create from dolfin::FunctionSpace.
             * @param space single dolfin::FunctionSpace (no product space)
             * @param dofmap map relating global ids of a product space to local ids in this single
             * space
             */
            VectorCreator( std::shared_ptr< dolfin::FunctionSpace > space,
         ...
         * @param space single dolfin::FunctionSpace (no product space)
         * @return @ref ::Spacy::makeHilbertSpace() "::Spacy::makeHilbertSpace( VectorCreator{space}
         * , l2Product{} )"
         */
         ...
         * VectorCreator{space,dofmap} , l2Product{} )"
         */
        VectorSpace
        makeHilbertSpace( std::shared_ptr< dolfin::FunctionSpace > space,
                          const std::unordered_map< std::size_t, std::size_t >& dofmap );
