...
namespace Spacy
{
    namespace Kaskade
    {
        ...
        public:
            ...
            {
            public:
                DomainCache( MassMatrix const&, typename AnsatzVars::VariableSet const&, int = 7 )
                {
                }
                ...
                template < int row >
                Scalar d1_impl( const ::Kaskade::VariationalArg<
                                Scalar, dim, TestVars::template Components< row >::m >& arg ) const
                {
                    return 0;
                }
                ...
                Scalar
                d2_impl( const ::Kaskade::VariationalArg<
                             Scalar, dim, TestVars::template Components< row >::m >& arg1,
                         const ::Kaskade::VariationalArg<
                             Scalar, dim, AnsatzVars::template Components< row >::m >& arg2 ) const
                {
                    if ( row == col )
            ...
            public:
                BoundaryCache( MassMatrix< RType, AnsatzVars > const&,
                               typename AnsatzVars::VariableSet const&, int = 7 )
                {
                }
