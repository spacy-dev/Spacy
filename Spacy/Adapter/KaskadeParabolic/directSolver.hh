  ...
  namespace KaskadeParabolic
  {
     ...
     */
      ...
      /**
         ...
         * @return DirectSolver<KaskadeOperator,AnsatzVariableSetDescription,TestVariableSetDescription>( H )
         */

      template <class OperatorDefinition>
      auto makeDirectSolver(LinearBlockOperator<typename OperatorDefinition::AnsatzVars,typename OperatorDefinition::AnsatzVars> &H)
      {
