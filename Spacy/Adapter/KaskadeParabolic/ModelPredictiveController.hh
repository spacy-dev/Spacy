        ...
        public:
            ...
            void MPCloop()
            {
                ...
                for ( auto i = 0u; i < no_mpc_steps; i++ )
                {
                    ...
                    // first initial value needs to be saved, all resulting initial values are given
                    // by last value of preceding loop,
                ...
                /// Visualize turnpike of Optimal Control problem (Just last value of trajectory,
                /// hoping it has approached the TP)
