    ...
    namespace KaskadeParabolic
    {
        namespace PDE
        {
            /**
                 ...
                 * @param x KaskadeParabolic Vector that holds the vector(i.e. function) to be
             * written
            ...
            void writeVTK( const Vector< Description >& x, const char* fileName )
            {
                ...
                {
                    ::Kaskade::writeVTKFile( gm.at( i )->grid().leafGridView(), x.get( i ),
                                             fileName + std::to_string( i ), ::Kaskade::IoOptions(),
                                             vc.getGridMan().getFEorder() );
                }
            }
            ...
            {
                auto x_impl =
                    ::Spacy::cast_ref<::Spacy::KaskadeParabolic::Vector< Description > >( x );
                auto vc = ::Spacy::creator< VectorCreator< Description > >( x.space() );
                auto gm = vc.getGridMan().getKaskGridMan();
                for ( auto i = 0u; i < gm.size(); i++ )
                {
                    ::Kaskade::writeVTKFile( gm.at( i )->grid().leafGridView(), x_impl.get( i ),
                                             fileName + std::to_string( i ), ::Kaskade::IoOptions(),
                                             vc.getGridMan().getFEorder() );
                }
            }
            ...
            auto printNormSolution(
                ::Spacy::Vector sol,
                ::Spacy::KaskadeParabolic::PDE::LinearBlockOperator< Descriptions, Descriptions >
                    Blockoperator,
                ::Spacy::KaskadeParabolic::GridManager< typename Descriptions::Spaces > gm,
                std::string name )
            {

                using CoefficientVectorY =
                    typename Descriptions::template CoefficientVectorRepresentation<>::type;

                // compute norm of exact solution
                auto timesteps = gm.getSpacesVec().size();
                auto sol_impl =
                    ::Spacy::cast_ref<::Spacy::KaskadeParabolic::Vector< Descriptions > >( sol );
                std::vector< double > norm_y;

                for ( auto i = 0u; i < gm.getSpacesVec().size(); i++ )
                {
                    CoefficientVectorY ydum(
                        Descriptions::template CoefficientVectorRepresentation<>::init(
                ...
                {
                    norm_y_os << tempgrid.at( i )
                              << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                    1 )
                              << " " << norm_y.at( i ) << std::endl;
                }
                norm_y_os.close();
            }
            ...
            auto printNormSolution(
                ::Spacy::Vector sol,
                ::Spacy::KaskadeParabolic::PDE::NormOperator< Descriptions, Descriptions >
                    NormOperator,
                ::Spacy::KaskadeParabolic::GridManager< typename Descriptions::Spaces > gm,
                std::string name )
            {
        ...
        namespace OCP
        {
            ...
            void writeVTK( const ::Spacy::Vector& x, const char* fileName )
            {
                ...
                auto vc =
                    ::Spacy::creator<::Spacy::KaskadeParabolic::VectorCreator< VYSetDescription > >(
                        x_y.space() );
                auto gm = vc.getGridMan().getKaskGridMan();
                ...
                for ( auto i = 0u; i < no_time_steps; i++ )
                {
                    ...
                    ::boost::fusion::at_c< 0 >( v.at( i ).data ) =
                        boost::fusion::at_c< 0 >( x_y_impl.get( i ).data );
                    ::boost::fusion::at_c< 1 >( v.at( i ).data ) =
                        boost::fusion::at_c< 0 >( x_u_impl.get( i ).data );
                    ::boost::fusion::at_c< 2 >( v.at( i ).data ) =
                        boost::fusion::at_c< 0 >( x_p_impl.get( i ).data );
                    ::Kaskade::writeVTKFile( gm.at( i )->grid().leafGridView(), v.at( i ),
                                             fileName + std::to_string( i ), ::Kaskade::IoOptions(),
                                             vc.getGridMan().getFEorder() );
                }
                return;
            ...
            /**
                 ...
                 */
            template < class Descriptions >
            auto printErrorDistribution(
                ::Spacy::Vector ex, ::Spacy::Vector inex,
                ::Spacy::KaskadeParabolic::OCP::LinearBlockOperator< Descriptions, Descriptions >
                    NormFunctional,
                ::Spacy::KaskadeParabolic::GridManager< typename Descriptions::Spaces > gm,
                std::string name )
            {
                ...
                std::get< 0 >( diff_tuple )
                    .subtractOtherTempGrid_linearInterpolated( std::get< 0 >( inex_tuple ) );
                std::get< 1 >( diff_tuple )
                    .subtractOtherTempGrid_linearInterpolated( std::get< 1 >( inex_tuple ) );
                std::get< 2 >( diff_tuple )
                    .subtractOtherTempGrid_linearInterpolated( std::get< 2 >( inex_tuple ) );
                ...
                for ( auto i = 0u; i < gm.getSpacesVec().size(); i++ )
                {
                    CoefficientVectorY ydum(
                        VYSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( ydum.data ) =
                        std::get< 0 >( diff_tuple ).getCoeffVec( i );
                    auto My = ydum;
                    ...
                    CoefficientVectorU udum(
                        VUSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( udum.data ) =
                        std::get< 1 >( diff_tuple ).getCoeffVec( i );
                    auto Mu = udum;
                    ...
                    CoefficientVectorP pdum(
                        VPSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( pdum.data ) =
                        std::get< 2 >( diff_tuple ).getCoeffVec( i );
                    auto Mp = pdum;
                ...
                for ( auto i = 0u; i < gm.getSpacesVec().size(); i++ )
                {
                    CoefficientVectorY ydum(
                        VYSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( ydum.data ) =
                        std::get< 0 >( ex_tuple ).getCoeffVec( i );
                    auto My = ydum;
                    NormFunctional.getKaskOp( "My", i ).apply( ydum, My );
                    ...
                    CoefficientVectorU udum(
                        VUSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( udum.data ) =
                        std::get< 1 >( ex_tuple ).getCoeffVec( i );
                    auto Mu = udum;
                    NormFunctional.getKaskOp( "Mu", i ).apply( udum, Mu );
                    ...
                    CoefficientVectorP pdum(
                        VPSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( pdum.data ) =
                        std::get< 2 >( ex_tuple ).getCoeffVec( i );
                    auto Mp = pdum;
                    NormFunctional.getKaskOp( "My", i ).apply( pdum, Mp );
                ...
                // Print into files
                std::ofstream relerr_y, relerr_u, relerr_p, abserr_y, abserr_u, abserr_p;
                ...
                for ( auto i = 0u; i < timesteps; i++ )
                {
                    relerr_y << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_y.at( i ) / exnorm_y.at( i ) << std::endl;
                    relerr_u << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_u.at( i ) / exnorm_u.at( i ) << std::endl;
                    relerr_p << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_p.at( i ) / exnorm_p.at( i ) << std::endl;

                    abserr_y << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_y.at( i ) << std::endl;
                    abserr_u << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_u.at( i ) << std::endl;
                    abserr_p << tempgrid.at( i ) << " "
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << diffnorm_p.at( i ) << std::endl;
                }
                relerr_y.close();
                relerr_u.close();
                relerr_p.close();
                ...
                std::string name )
            {
                ...
                for ( auto i = 0u; i < gm.getSpacesVec().size(); i++ )
                {
                    CoefficientVectorY ydum(
                        VYSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( ydum.data ) =
                        std::get< 0 >( sol_tuple ).getCoeffVec( i );
                    auto My = ydum;
                    NormFunctional.getKaskOp( "My", i ).apply( ydum, My );
                    norm_y.push_back( std::sqrt( ydum * My ) );
                    ...
                    CoefficientVectorU udum(
                        VUSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( udum.data ) =
                        std::get< 1 >( sol_tuple ).getCoeffVec( i );
                    auto Mu = udum;
                    NormFunctional.getKaskOp( "Mu", i ).apply( udum, Mu );
                    ...
                    CoefficientVectorP pdum(
                        VPSetDescription::template CoefficientVectorRepresentation<>::init(
                            *gm.getSpacesVec().at( i ) ) );
                    boost::fusion::at_c< 0 >( pdum.data ) =
                        std::get< 2 >( sol_tuple ).getCoeffVec( i );
                    auto Mp = pdum;
                ...
                for ( auto i = 0u; i < timesteps; i++ )
                {
                    ...
                    relerr_u << tempgrid.at( i )
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << " " << norm_u.at( i ) << std::endl;
                    relerr_p << tempgrid.at( i )
                             << std::setprecision( std::numeric_limits< long double >::digits10 +
                                                   1 )
                             << " " << norm_p.at( i ) << std::endl;
                }
            }
        }
    }
