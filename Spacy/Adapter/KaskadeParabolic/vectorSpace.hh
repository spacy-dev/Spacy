...
namespace Spacy
{
    ...
    {
        /// Creator for time dependent (piecewise constant in time) vector space elements
        /// implemented with %Kaskade 7
        ...
        public:
                ...
                : gm_( gm )
            {
                ...
                for ( auto i = 0u; i < spaces.size(); i++ )
                    creators_.push_back( std::make_shared< SubCreator< Description > >(
