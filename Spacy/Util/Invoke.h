...
namespace Spacy
{
    ...
    namespace InvokeDetail
    {
        ...
        decltype( auto ) invoke_helper( Func&& func, Tup&& tup, std::index_sequence< index... > /*unused*/ )
        {
            return func( std::get< index >( std::forward< Tup >( tup ) )... );
        }

        template < typename Type, typename Tup, std::size_t... index >
        decltype( auto ) create_helper( Tup&& tup, std::index_sequence< index... > /*unused*/ )
        {
    ...
    decltype( auto ) invoke( Func&& func, Tup&& tup )
    {
        ...
        return InvokeDetail::invoke_helper( std::forward< Func >( func ), std::forward< Tup >( tup ), std::make_index_sequence< Size >{} );
    }
    ...
    {
        constexpr auto Size = std::tuple_size< typename std::decay< Tup >::type >::value;
        return InvokeDetail::create_helper< Type >( std::forward< Tup >( tup ), std::make_index_sequence< Size >{} );
    }
} // namespace Spacy
