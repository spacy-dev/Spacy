...
namespace Spacy::Mixin
{
    namespace
    {
        ...
        auto ending()
        {
            if ( std::is_same< Unit, std::chrono::hours >() )
                return "h.";
            if ( std::is_same< Unit, std::chrono::minutes >() )
                return "m.";
            if ( std::is_same< Unit, std::chrono::seconds >() )
                return "s.";
            if ( std::is_same< Unit, std::chrono::milliseconds >() )
                return "ms.";
            if ( std::is_same< Unit, std::chrono::microseconds >() )
                return "mus.";
            if ( std::is_same< Unit, std::chrono::nanoseconds >() )
                return "ns.";
